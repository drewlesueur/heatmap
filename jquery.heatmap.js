...
function get_coordinateMapType(config) {       
       ...
       CoordMapType.prototype.maxZoom = 19;
        ...
        div.style.fontSize = '10';
                ...
                if (FF) {
                  $(div).append($("<img>").attr("src","data:image/png;base64," + data))
                  return div
                }
                  $.post(
                     config.echo ,
        ...
        var heat_map_options = {
            getTileUrl: function(coord, zoom) {
                ...
                */
                ...
                //window.open("http://www.google.com/images/nav_logo16.png")                 
                //return "http://www.google.com/images/nav_logo16.png";
               ...
               // return $('<img>').attr("src", "data:image/png;base64," + data)[0]
                //return $('<img>').attr("src", "http://www.google.com/images/nav_logo16.png")[0]
              },
